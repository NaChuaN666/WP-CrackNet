...
def main():
    ...
    # pred_folder = '/root/autodl-tmp/ACR_used_boundary/WPCRACK/experiments_deepcrack/0523_deepcrack_bs4_model3_grid_collo_6_newval_SelfCL_CE/version_10/out_ck199'
    
    # pred_folder = '/root/autodl-tmp/ACR_used_boundary/WPCRACK/experiments_deepcrack/0425_deepcrack_bs4_model3_grid_collo_6_newval_SEPath/version_4/seg_mask'
    
    pred_folder = '/root/autodl-tmp/ACR_used_boundary/WPCRACK/experiments_deepcrack/0613_deepcrack_PAAM_CECCM_used/version_1/out_ck168'
    
    gt_folder = '/root/autodl-tmp/ACR_used_boundary/WPCRACK/data/Deepcrack/all_labels'
